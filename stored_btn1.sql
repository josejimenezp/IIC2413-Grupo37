...
id_instalacion = instalacion.iid;
	...
	END if;
	ALTER TABLE fechas_table ADD COLUMN porcentaje_ocupacion real;
	UPDATE fechas_table SET porcentaje_ocupacion = porcentaje_capacidadvar WHERE fechas.fecha = fecha.fecha_atraque;
	END LOOP;
